            ...
            try {
                ...
                for (Map.Entry<String, String> entry : query.entrySet()) {
                    ...
                    if (entry.getKey().contains(FindConfig.MIN_)) {
                        ...
                        if (isNumeric(decodedValue)) {
                            sql.append("`"+min+"`").append(" >= ").append(decodedValue).append(" and ");
                        } else {
                            sql.append("`"+min+"`").append(" >= '").append(decodedValue).append("' and ");
                        }
                        continue;
                    ...
                    if (entry.getKey().contains(FindConfig.MAX_)) {
                        ...
                        if (isNumeric(decodedValue)) {
                            sql.append("`"+max+"`").append(" <= ").append(decodedValue).append(" and ");
                        } else {
                            sql.append("`"+max+"`").append(" <= '").append(decodedValue).append("' and ");
                        }
                        continue;
                    ...
                    if (like == true) {
                        sql.append("`"+humpToLine(entry.getKey())+"`").append(" LIKE '%").append(decodedValue).append("%'").append(" and ");
                    } else {
                        if (isNumeric(decodedValue)) {
                            sql.append("`"+humpToLine(entry.getKey())+"`").append(" = ").append(decodedValue).append(" and ");
                        } else {
                            sql.append("`"+humpToLine(entry.getKey())+"`").append(" = '").append(decodedValue).append("' and ");
                        }
                    }
